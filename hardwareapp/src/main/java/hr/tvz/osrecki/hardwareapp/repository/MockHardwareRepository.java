...
public class MockHardwareRepository implements HardwareRepository {
    private final List<Hardware> MOCK_HARDWARE = Arrays.asList(
            ...
            new Hardware("Intel Core i9-12900K", "BX8071512900K", 614.99, HardwareType.CPU, 2),
            ...
            new Hardware("GIGABYTE Gaming GeForce RTX 3070 Ti", "N82E16814932443", 858.33, HardwareType.GPU, 6),
            new Hardware("ASUS ROG Strix GeForce RTX 3090", "N82E16814126456", 1999.99, HardwareType.GPU, 1)
    );
